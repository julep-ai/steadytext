-- pg_steadytext--1.3.0.sql
-- Initial schema for pg_steadytext extension with AI summarization aggregates and reranking functions
...
-- Version 1.3.0 includes reranking functions for query-document relevance scoring
...
-- AIDEV-NOTE: This completes the base schema for pg_steadytext v1.3.0
-- 
