...
from benchmarks.speed.benchmark_speed import SpeedBenchmark, format_result, format_results_table
import steadytext
...
def run_all_benchmarks(args):
    ...
    print(f"\n{'='*80}")
    print(f"SteadyText Speed Benchmarks - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"{'='*80}\n")
    ...
    if not args.skip_model_loading:
        ...
        result = benchmark.benchmark_model_loading(iterations=args.model_loading_iterations)
...
def main():
    ...
    parser.add_argument('--streaming-iterations', type=int, default=50,
    ...
    parser.add_argument('--model-loading-iterations', type=int, default=3,
                       help='Number of model loading iterations (default: 3)')
    parser.add_argument('--concurrent-iterations', type=int, default=10,
    ...
    parser.add_argument('--max-workers', type=int, nargs='+', default=[1, 2, 4, 8],
    ...
    parser.add_argument('--skip-cache', action='store_true',
                       help='Skip cache performance benchmark')
