...
class SpeedBenchmark:
    ...
    def benchmark_generation_streaming(
        ...
        result = BenchmarkResult(
            operation="generation_streaming",
            iterations=iterations
        )
    ...
    def benchmark_embedding(
        ...
        for batch_size in batch_sizes:
            result = BenchmarkResult(
                operation=f"embedding_batch_{batch_size}",
                iterations=iterations
            )
    ...
    def benchmark_concurrent(
        ...
        for workers in max_workers:
            ...
            result.times = [total_time / (workers * iterations_per_worker)] * result.iterations
...
def format_results_table(results: List[BenchmarkResult]) -> str:
    ...
    headers = ["Operation", "Mean (ms)", "P95 (ms)", "P99 (ms)", "Throughput", "Memory (MB)", "Errors"]
    rows = []
