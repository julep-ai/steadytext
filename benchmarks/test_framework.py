...
def test_benchmark_framework():
    ...
    try:
        ...
        from benchmarks.speed.benchmark_speed import BenchmarkResult, format_result, format_results_table
...
def mock_steadytext_functions():
    ...
    sys.modules['steadytext.core.generator'] = type('Module', (), {
